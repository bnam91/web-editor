...
const UNNETTED_BACKLOG = {
  ...
  'js/history.js':              [237, 366],  // 같은 두 자리(restoreSnapshot·restoreSnapshotScoped 의 rAF 해제). 줄만 계속 밀린다 — 115·243 → 161·290 → (resize-undo)151·279 / (grad-alpha)211·340 → 통합 int/0920b 에서 둘 다 들어가 247·376 → (T-079 패널표 이사로 _PANEL_BY_CLASS 가 js/panel-dispatch.js 로 빠져 24줄 당겨짐)223·352 → (T-131 이음매 주석 14줄 추가로 밀림)237·366. ★자리는 그대로고 «줄만» 밀렸다 — 새 해제 자리가 는 것이 아니다.
