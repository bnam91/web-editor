...
const SCENARIO = async (which) => {
  ...
  /* ★★[2026-09-24 T-179] 「꼭대기 표본이 라이브를 따라잡을 때까지」 — «마감 있는 조건 대기».
     ...
     ⛔★[2026-09-24 부하를 적고 다시 재서 보탠다] 이 흔들림은 «기계가 바쁠 때»가 아니라
       «한가할 때» 더 심하다 — 고정 대기가 setTimeout(20ms) 라, 기계가 바쁘면 그 타이머도
       같이 늦어져 rAF 사슬이 따라잡을 틈이 생긴다. 실측:
         · 낮은 부하(안 적음)      기준판 M9 10회 중 2회 빨강
         · load 37~94, 12코어      기준판 M9 12회 중 «0회» 빨강 — 재현 안 됨
         · load 32~48, 12코어      고친 판 M9·M11·N3·N5 10회 전부 초록
       ⇒ ★「바쁜 기계에서 다시 돌려 초록」을 「고쳐졌다」로 읽으면 안 된다. 여기선 그 반대다.
