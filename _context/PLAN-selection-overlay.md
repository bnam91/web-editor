...
+ ★코너 일치: path 꼭지점 ↔ 핸들 중심 — **축별 ≤ (그 선의 반굵기) + 1/dpr**.
  ...
  ★기준을 바꾸기 «전에» 검증했다(2026-09-06, 880 표본 = 줌 4단 × 서브픽셀 위상 5 × 상자 × 4모서리):
    ...
    ★관측되는 모습 = «상한 바로 아래에서 진동». 줌과 «단조 관계가 없다».
      적대검수 1,920 표본 max = 0.9781/0.9531/0.9125/0.9578/0.9844/0.9766/0.9922/0.9375
    ⛔「줌이 올라갈수록 감소한다」로 쓰지 마라 — 표본이 적을 때 보이던 착시였고 두 번(1,344·1,920) 거짓 확인.
