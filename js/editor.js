...
function zoomStep(delta) {
  ...
  const selectedBlock = delta > 0 && document.querySelector(
    '.text-block.selected, .asset-block.selected, .gap-block.selected, ' +
    '.icon-circle-block.selected, .table-block.selected, .label-group-block.selected, ' +
    '.graph-block.selected, .divider-block.selected, .bridge-block.selected, ' +
...
function duplicateSelected() {
  ...
  const selBlock = document.querySelector(
    '.text-block.selected, .asset-block.selected, .gap-block.selected, ' +
    '.icon-circle-block.selected, .shape-block.selected, .divider-block.selected, .bridge-block.selected, ' +
  ...
  if (selBlock) {
    ...
    if (absWrapper && parentFrame) {
      ...
      // 이벤트 재바인딩
      const _ALL_BLOCK_SEL = '.text-block, .shape-block, .asset-block, .gap-block, .icon-circle-block, .table-block, .label-group-block, .graph-block, .divider-block, .bridge-block, .icon-text-block, .icon-block, .canvas-block, .banner02-block, .comparison-block, .vector-block, .chat-block, .laurel-block, .step-block, .mockup-block, .gradient-block, .speech-bubble-block';
    ...
    if (e.key === 'a') {
      ...
      if (activeSec) {
        const allBlocks = activeSec.querySelectorAll(
          ...
          '.label-group-block, .graph-block, .divider-block, .bridge-block, .icon-text-block, .canvas-block, .banner02-block, .comparison-block, .vector-block'
        );
  ...
  let consumed = false;
    ...
    if (selSS) {
      const ssHasSelectedChild = selSS.querySelector(
        '.text-block.selected, .asset-block.selected, .gap-block.selected, ' +
        '.icon-circle-block.selected, .table-block.selected, .label-group-block.selected, ' +
        '.graph-block.selected, .divider-block.selected, .bridge-block.selected, .icon-text-block.selected, .canvas-block.selected, .banner02-block.selected, .comparison-block.selected, .mockup-block.selected, .icon-block.selected, .vector-block.selected, .step-block.selected'
      );
...
function deselectAll() {
  ...
  canvas.querySelectorAll('.gap-block, .icon-circle-block, .graph-block, .divider-block, .bridge-block, .icon-text-block, .joker-block, .shape-block, .canvas-block, .banner02-block, .comparison-block, .mockup-block, .icon-block, .vector-block, .step-block, .chat-block, .laurel-block, .annotation-block, .sticker-block').forEach(b => {
...
document.querySelectorAll('.section-block').forEach(sec => {
  sec.addEventListener('click', e => {
    ...
    if (row && !e.target.closest('.text-block, .asset-block, .gap-block, .col-placeholder, .icon-circle-block, .table-block, .graph-block, .divider-block, .bridge-block, .label-group-block, .icon-text-block, .canvas-block, .banner02-block, .comparison-block, .vector-block')) {
...
/* ── Static 블록 초기 바인딩 ── */
document.querySelectorAll('.text-block, .asset-block, .gap-block, .icon-circle-block, .table-block, .label-group-block, .graph-block, .divider-block, .bridge-block, .icon-text-block, .canvas-block, .banner02-block, .comparison-block, .icon-block, .mockup-block, .vector-block, .step-block, .chat-block, .laurel-block').forEach(b => window.bindBlock(b));
...
canvasEl.addEventListener('click', e => {
  ...
  if (!col) return;
  // 블록 클릭은 블록 핸들러에게 위임
  if (e.target.closest('.text-block, .asset-block, .gap-block, .icon-circle-block, .table-block, .graph-block, .divider-block, .bridge-block, .label-group-block, .icon-text-block, .canvas-block, .banner02-block, .comparison-block, .vector-block')) return;
