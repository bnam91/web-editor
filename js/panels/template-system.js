...
async function insertTemplate(tpl) {
  ...
  if (tpl.type === 'subsection') {
    ...
    ss.querySelectorAll('.text-block, .asset-block, .gap-block, .icon-circle-block, .table-block, .label-group-block, .graph-block, .divider-block, .bridge-block, .duo-block, .infocard-block, .icon-text-block, .shape-block, .joker-block').forEach(b => window.bindBlock?.(b));
  ...
  sec.querySelectorAll('.text-block, .asset-block, .gap-block, .icon-circle-block, .table-block, .label-group-block, .graph-block, .divider-block, .bridge-block, .duo-block, .infocard-block, .icon-text-block').forEach(b => bindBlock(b));
