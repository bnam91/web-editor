...
function makeLayerBlockItem(block, dragTarget, sec, depth = 1) {
  ...
  item.addEventListener('click', e => {
    ...
    else if (isBanner02) window.showBanner02Properties?.(block);
    else if (isComparison) window.showComparisonProperties?.(block);
