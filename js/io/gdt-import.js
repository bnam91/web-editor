...
(function () {
  ...
  const REJECT_MESSAGE = {
    ...
    // ★§11-2 폰트 목록 — 「손상」이 아니라 «비정상»으로 구분해 알린다(정상 파일은 3종 안쪽이다)
    too_many_fonts:             '글꼴 목록이 비정상적으로 많습니다. 신뢰할 수 있는 파일인지 확인해 주세요.',
    font_name_too_long:         '글꼴 이름이 비정상적으로 깁니다. 신뢰할 수 있는 파일인지 확인해 주세요.',
    fonts_malformed:            '글꼴 목록의 형식이 올바르지 않습니다. 정상적으로 만들어진 파일이 아닙니다.',
