    ...
    '0.9.1': {
      ...
      items: [
        ...
        { k: 'new', t: '상단바에 현재 버전 표시',
          d: '문의 시 이 번호를 함께 알려주면 확인이 빠르다.' },
        { k: 'fix', t: '여러 블록 복사 시 순서가 뒤섞이던 문제',
          d: '이미지·스텝을 함께 골라도 둘씩 뭉쳐 붙던 것을 고쳤다. 이제 고른 순서 그대로, 열 개도 그대로.' },
        { k: 'fix', t: '스크래치 그룹 해제 후에도 섹션을 따라다니던 문제',
          d: '그룹만 풀리고 연결이 남아 섹션을 옮기면 같이 움직였다. 이제 그룹을 풀면 연결도 끊긴다.' },
        { k: 'imp', t: '업데이트 후 남던 설치 파일 자동 정리',
          d: '다음 실행 때 정리한다. 맥 약 353MB · 윈도우 약 337MB 확보.' },
      ],
    },
  };
