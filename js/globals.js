...
export const state = {
  pageSettings: { bg: '#969696', gap: 100, padX: 32, padY: 0, padXExcludesAsset: false },
  pages: [{ id: 'page_1', name: 'Page 1', label: '', pageSettings: { bg: '#969696', gap: 100, padX: 32, padY: 0, padXExcludesAsset: false }, canvas: '' }],
